...
$(document).ready(function(){
    ...
    imgMain=new Image();
    imgMain.src ="picture/images/spriteSheet.png";
    currentImgMainX=0;
    currentImgMainY=0;
    ...
    imgMountain.src="picture/images/material.png";
    imgEnemy=new Image();
    imgEnemy.src="picture/images/Enemy.png";
  ...
  var targetImgMainX,targetImgMainY,targetBlock,cutImagePositionX;
    ...
    {}
        ...
        switch(mapArray[targetBlock]){
            case undefined:$("#talkBox").text("邊界");
                break;
                case 1 :
                $("#talkBox").text("有山");
                break;
